...
class MeetUpScreen extends StatelessWidget {
          ...
          child: Column(children: [
            ...
            Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  border: Border.all(color: const Color.fromARGB(230, 9, 113, 239)),
                          ...
                          itemBuilder: (_, index) {
                            return Padding(
                              ...
                              child: Container(
                                ...
                                child: Container(
                                  decoration:
                                      BoxDecoration(border: Border.all(color: Colors.grey[400]!), borderRadius: BorderRadius.circular(10)),
                                  child: Column(
                                    ...
                                    children: [
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: Container(
                                              ...
                                              child: ClipOval(
                                                child: Image.asset('assets/persons/images1.jpeg', fit: BoxFit.cover),
                                              ),
                                            ),
                                          ),
                                          const Column(
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            profiles(context, 'assets/persons/images3.jpg'),
                                            profiles(context, 'assets/persons/images2.jpeg'),
                                            profiles(context, 'assets/persons/images4.jpeg'),
                                            // Container(
                                            //   height: 40,
                                            //   width: 40,
                                            //   decoration:
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  const Text("Top Trending Meetups", style: TextStyle(fontSize: 18)),
                  Expanded(
                      child: ListView.builder(
                          scrollDirection: Axis.horizontal,
                          itemCount: 3,
                                    ...
                                    child: GestureDetector(
                                      onTap: () {
                                        Navigator.of(context)
                                            .push(MaterialPageRoute(builder: (context) => DescriptionScreen()));
                                      },
                                      child: Image.asset(
                                        meetups[index],
                                        fit: BoxFit.cover,
  ...
  Widget profiles(BuildContext context, String imgUrl) {
    return Container(
      height: 40,
      width: 40,
